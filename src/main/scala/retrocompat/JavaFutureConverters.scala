...
import retrocompat.FutureConvertersImpl.{CF, P}
...
/** This object contains methods that convert between Scala [[Future]] and Java [[CompletionStage]].
  ...
  * code, it is recommended to use the extension methods defined in [[retrocompat.FutureConverters]].
  *
