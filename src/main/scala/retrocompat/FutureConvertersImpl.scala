...
import java8.util.concurrent.{CompletableFuture, CompletionStage}
import java8.util.function.{BiConsumer, BiFunction, Consumer, Function => JFunction}

import scala.concurrent.Future
import retrocompat.Promise.DefaultPromise
